              ...
              {order.products.map((item, index) => (
                <tr key={index} className="">
                        ...
                        <td className="border cursor-pointer p-2 flex items-center gap-2">
                          {item.productId ? <a href={item.productId?.image} target="_blank" rel="noopener noreferrer">
                            <Image
                            ...
                            :
                            <span>
                              seller removed this product
                            </span>
                          }
                          {item.productId?.title || "N/A"}
                        </td>

                        <td className="border p-2">{item.productId?.price?.toFixed(2) || "N/A"}</td>
                        <td className="border p-2">{item.quantity || "N/A"}</td>
                        <td className="border p-2">
                       {(item.quantity * item.productId?.price).toFixed(2) || "N/A"}
                        </td>
