export const orderConfirmationTemp = (order) => {
  ...
  console.log('orderConfirmationTemp ', order);
  ...
  <head>
      ...
      <title>Order Confirmed - Saadi Collection</title>
      <style>
          /* Base Styles */
          body {
  ...
  <body>
      <div class="container">
          ...
          <div class="header">
              ...
              <p>Thank you for shopping with Saadi Collection</p>
          </div>
    ...
    <td valign="top" width="50%" style="padding:10px; border:1px solid #eee;">
      ...
      <p><strong>Delivery:</strong> ${order.isDelivered ? 'Delivered' : 'Processing'}</p>
              ...
              <div class="button-container">
                  <a href="${websiteUrl}/buyer/orders" class="btn">View Your Order</a>
