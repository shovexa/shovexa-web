export const sellerRejectionTemp = (name) => {
  ...
  <body>
      <div class="container">
          <img src="${WEBSITE_URL}/logo.jpg" alt="shovexa.com Logo" class="logo" />
          <div class="header">
              <h2>Store Request Rejected</h2>
          </div>
          <div class="content">
              <p>Dear ${name || "Applicant"},</p>
              <p>We appreciate your interest in becoming a seller on <strong>shovexa.com</strong>. After careful review, we regret to inform you that your store request has not been approved at this time.</p>
